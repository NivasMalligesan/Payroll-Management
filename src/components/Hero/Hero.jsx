  ...
  return (
    <section className="relative overflow-hidden bg-light">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-7 min-h-[550px] py-10" >
            ...
            <div className='relative z-0 flex flex-col justify-center py-14 md:py-0 col-span-4'>
                <div className='space-y-5 text-center md:text-left lg:max-w-[400] me-10'>
                    <h1 className="text-6xl lg:text-7xl !leading-snug font-poppins font-bold">Global Payroll <br />
            ...
            className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 md:object-cover md:-ml-4 lg:-ml-0 
                        transition-transform duration-300 ease-in-out hover:-translate-x-20 col-span-3 "
            />
        </div>
    </section>
  )
